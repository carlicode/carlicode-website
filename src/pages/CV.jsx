...
export default function CV() {
  return <main className="cv-page"><Helmet><title>CV — Carla Florida | Carli Code</title><meta name="description" content="CV de Carla Florida, AI Engineer, Tech Lead y creadora de Carli Code." /></Helmet>
    ...
    <section className="cv-links"><p>LINKS</p><div><a href="https://www.linkedin.com/in/carlicode/" target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight size={16} /></a><a href="https://github.com/carlicode" target="_blank" rel="noreferrer">GitHub <ArrowUpRight size={16} /></a><a href="https://platzi.com/profes/carlicode/" target="_blank" rel="noreferrer">Platzi Courses <ArrowUpRight size={16} /></a><a href="https://g.dev/carlicode" target="_blank" rel="noreferrer">Google Developer <ArrowUpRight size={16} /></a></div><a className="cv-email" href="/downloads/carla-florida-cv-2026.pdf" download="Carla_Florida_CV_2026.pdf">Download CV <Download size={16} /></a></section>
  </main>;
}
